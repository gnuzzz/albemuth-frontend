 ...
 * Time: 2:37:23
 */
public final class PrimitiveFloatProperty extends PlainProperty {

    public PrimitiveFloatProperty(String name, Class targetClass, Method getterMethod, Method setterMethod, Field field) {
    ...
    public void setValue(Object target, String value) throws PropertyException {
        try {
            setValue(target, Float.valueOf(value));
