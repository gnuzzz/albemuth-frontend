...
public class TestTextField extends TestFrontend {

    public void testOneFormWithOneTextField() {
        try {
            ...
            parser.setComponentContent("/ru/albemuth/frontend/components/TTextFieldDocument",
                    "<html>" +
                    "<body>" +
                    "<form cid=\"Form\" listener=\"setFormValues\" response=\"FORWARD\" name=\"tff\">" +
                    "<input cid=\"TextField\" type=\"text\" name=\"selected-value\" value=\"$valueSelected.value\" />" +
                    "<input cid=\"SubmitButton\" listener=\"setFormValues\" response=\"FORWARD\" type=\"submit\" name=\"sb\" value=\"Ok\" />" +
                    "</form>" +
                    "</body>" +
                    "</html>"
            );
            ComponentDescriptor cd = parser.getDocumentDescriptor("TTextFieldDocument");
            TTextFieldDocument doc = (TTextFieldDocument)cd.createComponent(null);
...
System.out.println(doc.getRequestContext().getResponse());
            assertTrue(doc.getRequestContext().getResponse().indexOf("<input name=\"selected-value\" value=\"a\"     type=\"text\" />") != -1);
            assertEquals("a", doc.getValueSelected().getValue());

            request = createHttpServletRequest(doc);
            request.mockSetRequestURI("http://localhost/" + doc.getName());
            request.mockSetParameter("tff", "");
            request.mockSetParameter("sb", "Ok");
            request.mockSetParameter("selected-value", "d");
            engine.service(request, createHttpServletResponse());
            assertTrue(doc.getRequestContext().getResponse().indexOf("<input name=\"selected-value\" value=\"d\"     type=\"text\" />") != -1);
    ...
    public void testOneFormWithManyTextFields() {
        try {
            TComponentParser parser = new TComponentParser(new ComponentClassBuilderJavassistImpl("test"));
            parser.configure(new Configuration(new Properties()));
            parser.setComponentContent("/ru/albemuth/frontend/components/TTextFieldDocument",
                    ...
                    "<input cid=\"TextField\" type=\"text\" name=\"selected-value\" value=\"$valueItem.value\" itemid=\"$valueItem.value\" />" +
                    "</span>" +
                    "<input cid=\"SubmitButton\" listener=\"setFormValues\" response=\"FORWARD\" type=\"submit\" name=\"sb\" value=\"Ok\" />" +
                    "</form>" +
                    "</body>" +
            ...
            engine.service(request, createHttpServletResponse());
            assertTrue(doc.getRequestContext().getResponse().indexOf("<input name=\"selected-value.d\" value=\"d\"     type=\"text\" />") != -1);
    ...
    public void testManyFormWithOneTextField() {
        try {
            TComponentParser parser = new TComponentParser(new ComponentClassBuilderJavassistImpl("test"));
            parser.configure(new Configuration(new Properties()));
            parser.setComponentContent("/ru/albemuth/frontend/components/TTextFieldDocument",
                    ...
                    "<form cid=\"Form\" listener=\"setFormValues\" response=\"FORWARD\" name=\"tff\">" +
                    "<input cid=\"TextField\" type=\"text\" name=\"selected-value\" value=\"$valueItem.value\" />" +
                    "<input cid=\"SubmitButton\" listener=\"setFormValues\" response=\"FORWARD\" type=\"submit\" name=\"sb\" value=\"Ok\" />" +
                    "</form>" +
                    "</span>" +
                    "</body>" +
            ...
            engine.service(request, createHttpServletResponse());
            assertTrue(doc.getRequestContext().getResponse().indexOf("<input name=\"selected-value.2\" value=\"3\"     type=\"text\" />") != -1);
    ...
    public void testManyFormWithManyTextFields() {
        try {
            TComponentParser parser = new TComponentParser(new ComponentClassBuilderJavassistImpl("test"));
            parser.configure(new Configuration(new Properties()));
            parser.setComponentContent("/ru/albemuth/frontend/components/TTextFieldDocument",
...
abstract class TTextFieldDocument extends Document {
    ...
    public TTextFieldDocument(String name) {
        super(name);
    }
